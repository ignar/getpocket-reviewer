...
module Dry::Types
  ...
  extend Anonymous_Dry_Core_Deprecations_Tagged_4
  extend Anonymous_Dry_Core_Deprecations_Tagged_6
  extend Anonymous_Dry_Core_Deprecations_Tagged_9
...
module Anonymous_Dry_Core_Deprecations_Tagged_4
end
...
class Dry::Types::Schema::Key
  ...
  def to_ast(meta: nil); end
  def try(input, &block); end
  extend Anonymous_Dry_Core_Deprecations_Tagged_21
  extend Dry::Core::Deprecations::Interface
...
module Anonymous_Dry_Core_Deprecations_Tagged_21
end
...
module Anonymous_Dry_Core_Deprecations_Tagged_6
end
...
module Anonymous_Dry_Logic_Rule_Interface_25
  def [](input0); end
  def call(input0); end
  def initialize(*arg0); end
end
class Dry::Logic::Rule::Predicate::Predicate2Arity1Curried < Dry::Logic::Rule::Predicate
  include Anonymous_Dry_Logic_Rule_Interface_25
end
...
module Anonymous_Dry_Core_Deprecations_Tagged_9
end
